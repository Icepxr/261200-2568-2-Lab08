...
public class Turtle implements Runnable, ActionListener, MouseListener, MouseMotionListener, KeyListener, ComponentListener, MouseWheelListener
{
    ...
    {
        dob turtle = new dob(20,300,300,"red");
        dob turtle_2 = new dob(350,300,400,"green");
        dob turtle_3 = new dob(350,20,600,"yellow");
        dob turtle_4 = new dob(20,20,700,"blue");


        Thread t1 = new Thread(turtle);
        Thread t2 = new Thread(turtle_2);
        Thread t3 = new Thread(turtle_3);
        Thread t4 = new Thread(turtle_4);
